...
namespace projeto4
{
    public partial class FormRelatorioCurso : MaterialForm
    {
        ...
        private void MontaRelatorio()
        {
            ...
            if (txtAnoCriado.Text != "")
                sqlAd.SelectCommand.Parameters.AddWithValue("@ano_criado", txtAnoCriado.Text);
            ...
            page.Canvas.DrawString("Relatório de Curso", font1, brush1, page.Canvas.ClientSize.Width / 2, y, format1);
